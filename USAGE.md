...
Document version: **2026-09-08.1**. These exact texts are included in Branchline 0.1.0 (5), 0.2.0 (6), 0.3.0 (7), 0.3.1 (8) and 0.4.0 (9).
...
renewal. The current Branchline 0.4.0 download supports purchased licenses and existing
...
Branchline-owned material in this repository is covered by the [repository notice](LICENSE).
