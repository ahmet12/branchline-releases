...
Destek, göndermeyi seçtiğiniz iletişim bilgilerini, mesajları ve ekleri alır. Branchline tanılama raporu yerel olarak hazırlanır ve önizlenir; kaydetmek raporu yüklemez. Otomatik kararlılık raporlaması başlangıçta kapalıdır; aşağıda açıklanan ayrı, isteğe bağlı ayar ile açılabilir. macOS'in kendi tanılama paylaşım ayarları ayrıdır.
