...
<details>
<summary>See the full-center diff workspace</summary>

![Selecting LibraryView.swift replaces the graph with its diff while the changed-file tree stays on the right](assets/diff.png)
